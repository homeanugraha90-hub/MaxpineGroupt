      ...
      <div className="container mx-auto px-4 lg:px-24 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              ...
              <div className="border-t bg-gray-50 p-6">
                <h3 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <Navigation className="w-5 h-5 text-[#29aa8a]" />
            ...
            <div className="bg-gradient-to-r from-[#29aa8a] to-[#238b73] rounded-lg shadow-lg p-8 mt-6 text-white">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
              ...
              <div className="mt-8 pt-6 border-t">
                ...
                <button className="w-full bg-[#29aa8a] hover:bg-[#238b73] text-white py-3 rounded-lg font-semibold transition-colors">
                  Contact Sales Team
                </button>
              </div>
            </div>
