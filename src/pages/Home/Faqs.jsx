      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#7575a3] rounded-full flex items-center justify-center">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#7575a3] rounded-full opacity-20 animate-pulse"></div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-[#7575a3] font-semibold text-sm uppercase tracking-wider">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <span className="text-[#7575a3] font-bold text-lg min-w-[2rem]">
                        {index + 1}.
                      </span>
                    ...
                    <div className={`flex-shrink-0 w-8 h-8 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 ${
                      openFAQ === faq.id ? 'border-[#7575a3] bg-[#7575a3] text-white rotate-45' : 'hover:border-[#7575a3]'
                    }`}>
                      {openFAQ === faq.id ? (
            ...
            {/* Contact CTA */}
            <div className="bg-gradient-to-r from-[#7575a3] to-[#616193] rounded-xl p-6 text-white">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <Link to="/contact">
                <button className="bg-white text-[#7575a3] font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors duration-200 whitespace-nowrap">
                  Contact Us
                </button>
                </Link>
              </div>
