  ...
  return (
    <section className="py-24 bg-gradient-to-r from-gray-900 to-gray-700 text-white relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Header */}
        <p className="text-[#7575a3] font-semibold uppercase tracking-widest text-sm mb-2">
        ...
        {/* Testimonial Card */}
        <div className="relative bg-gray-800 rounded-3xl p-10 sm:p-14 lg:p-16 shadow-2xl border-2 border-[#7575a3]">
          {/* Quote Icon */}
          <div className="text-[#7575a3] text-6xl sm:text-7xl lg:text-8xl mb-6">❝</div>
              ...
              <button
                ...
                className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all ${
                  currentTestimonial === index
                    ? "bg-indigo-400 w-6 sm:w-8 h-3 sm:h-4 shadow-lg"
